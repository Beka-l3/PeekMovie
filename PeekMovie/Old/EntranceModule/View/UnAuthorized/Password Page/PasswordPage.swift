...
final class PasswordPage: UIViewController, Colors, Informatives {
    ...
    init() {
        viewComponents = PasswordViewComponents()
    ...
    override func viewDidLoad() { super.viewDidLoad()
        ...
        viewComponents.continueButton.addTarget(self, action: #selector(handleContinueButton), for: .touchUpInside)
    }
    ...
    private func setupViews() {
        let passwordView = viewComponents.passwordView
    ...
    @objc func handleContinueButton() {
        ...
        let password = viewComponents.passwordInput.text ?? EPConstants.emptyText
